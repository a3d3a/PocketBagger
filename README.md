...
Multiple splitting strategies were employed to evaluate our approach, including random, chain-aware, protein-aware, and 30% identity sequence-cluster-aware to probe generalizability. Further segmentation of performance was considered to inlier/outlier labels assigned by the isolation forest model.
